...
class Tip {
    ...
    getMiniplayerAnimation(tipOverMiniplayer) {
            ...
            this.root?.addEventListener("scroll", (scroll)=>{
                ...
                if (Math.abs(this.scrollLastSample - tipBox.y) > this.scrollSampling) {
                    ...
                    if (this.animationLock === false && tipOverMiniplayer === this.asMiniplayer) {
                        ...
                        (0, _popmotion.animate)(this.getMiniplayerAnimation(tipOverMiniplayer));
    ...
    next() {
        ...
        ;
        this.currentStep++;
        if (this.currentStep === this.steps.length) // we should summon "congrats ! we're finished here!"
        this.reset(false);
        else this.steps[this.currentStep]?.display();
    ...
    reset(showTutorial) {
        ...
        (0, _popmotion.animate)(this.getMiniplayerAnimation(true));
    }
}
